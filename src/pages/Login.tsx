            ...
            <div className="relative p-8 sm:p-10">
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-bold text-emerald-100 mb-2">
                    Tên đăng nhập
                  </label>
                  <motion.div
                    className="relative"
                  ...
                  >
                    ...
                    <input
                      {...register("membername")}
                      className="w-full pl-12 pr-4 py-4 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-white/60 focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400/50 backdrop-blur-sm transition-all duration-300 font-medium"
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-14 py-4 bg-white/10 border border-white/20 rounded-2xl text-white placeholder-white/60 focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400/50 backdrop-blur-sm transition-all duration-300 font-medium"
